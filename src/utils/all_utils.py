...
def save_reports(report: dict, report_path: str, indentation = 4):
    with open(report_path, "w") as f:   ## We are writing into the report_path because we want that the results of diff experiments to be overwritten for comparison
